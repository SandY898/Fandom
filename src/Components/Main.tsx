...
const Main = () => {
  ...
  //@ts-ignore
  const oneScroll = () => oneRef.current.scrollIntoView({block:"start", behavior: 'smooth'});
  ...
  return (
    ...
    >
      <div className={classes["Main"]}>
        <header className={classes["Main__Header"]}>
          <div className={classes["Main__Header-top"]}>
            ...
            <div className={classes["Main__Header-top--a"]}>
              ...
              <div data-logout="scroll" onClick={() => oneScroll()} className={classes["Main__Header-top--a-svgtext"]}>
                аниме
              </div>
            </div>
            <div className={classes["Main__Header-top--a"]}>
        ...
        { token ? (
            <UIButton onClick={() => removeToken()} type="number">Выйти</UIButton>
          ):(
          <>
        ...
        <div className={classes["Main__Footer"]}>
          <div className={classes["Main__Footer-blocks"]}>
            ...
            <div className={classes["Main__Footer-blocks__movies"]}>
              <div className={classes["Main__Footer-blocks__items"]}>
                MOVIES
              </div>
              <div className={classes["Main__Footer-blocks__item"]}>
                {" "}
            ...
            <div className={classes["Main__Footer-blocks__anime"]}>
              ...
              <div data-testid="cypress-title" className={classes["Main__Footer-blocks__item"]}>
                My Hero Aacademia
              </div>
            </div>
            ...
            <div className={classes["Main__Footer-blocks__more"]}>
              ...
              <a href="https://www.fandom.com/explore">
                <div data-logout="golink" className={classes["Main__Footer-blocks__arrow"]}>
                  <BsArrowRight />
                </div>
              </a>
            </div>
      ...
      <div ref={oneRef} style={{height: '1000px', textAlign: 'center'}}>/\/ /\/ /\/ /\/ /\/</div>
    </motion.div>
  );
};
